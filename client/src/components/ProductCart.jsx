...
const ProductCard = ({ product }) => {
    ...
    className = "border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white w-[200px]" >
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e) => {e.stopPropagation()}} className="text-primary">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-primary/10 border border-primary/40 md:w-[80px] w-[64px] h-[34px] rounded text-primary font-medium" onClick={() => addToCart(product._id)} >
