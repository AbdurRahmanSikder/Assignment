...
const Seller = () => {
    ...
    const { axios, navigate, products, setProducts } = useAppContext();
        ...
        <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <input onChange={(e) => setCategory(e.target.value)} value={category} id="product-category" type="text" placeholder="Type here" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                ...
                <button className="px-8 py-2.5 bg-blue-500 text-white font-medium cursor-pointer">ADD</button>
            </form>
        </div>
    );
};
